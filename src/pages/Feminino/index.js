        ...
        <div>
            ...
            <div className='camisafit23'>
                <div className='produto'>
                    ...
                    <h4>BLUSA MOLETOM CAPUZ ESSENTIALS LOGO COLORBLOCK</h4>
                    <div className='logos'>
                        <div className='centauro'>
                            <a href="https://www.adidas.com.br/blusa-moletom-capuz-adidas-essentials-logo-colorblock/GL1444.html" target='_blank'><img alt='centauro' src={sp}></img><h4>R$ 229,99</h4></a>
                            <a href="https://www.netshoes.com.br/moletom-adidas-capuz-essentials-logo-colorblock-feminina-azul-2FW-4108-008" target='_blank'><img alt='centauro' src={adidas}></img><h4>Esgotado</h4></a>
                            <a href="https://www.allianzparqueshop.com.br/moletom-adidas-capuz-colorblock-canguru-feminino-azul+bege-NQQ-7236-842" target='_blank'><img alt='centauro' src={allianz}></img><h4>R$ 290,99</h4></a>
                        </div>
                    </div>
                </div>
                <div className='produto'>
                    <img alt='nike' src={f002}></img>
                    <h4>Top Fitness sem Costura Bodywear Puma com 2 Unidades - Adulto</h4>
                    <div className='logos'>
                        <div className='centauro'>
                            <a href='https://www.centauro.com.br/top-fitness-sem-costura-bodywear-puma-com-2-unidades-adulto-978730.html?cor=H3&google=2&merchant=true&gclid=CjwKCAjw3ueiBhBmEiwA4BhspNfsjfgZgOeMJF32-SGnAvvL4E0yz0OiS2mN0rZNmHjH5ejSSyVJexoC-tcQAvD_BwE' target='_blank'><img alt='nike' src={centauro}></img><h4>R$ 69,00</h4></a>
                            <a href='https://www.netshoes.com.br/top-puma-nadador-sem-costura-feminino-preto-2I3-4108-006?campaign=gglepqpla&gclid=CjwKCAjw3ueiBhBmEiwA4BhspLYhrTgN8kSjhlkrPZf86bvlu0nDqzLUCsOfWwyS5JlkkjN4A6GPBBoChJ0QAvD_BwE&gclsrc=aw.ds' target='_blank'><img alt='nike' src={net}></img><h4>R$ 47,76</h4></a>
                        </div>
                    </div>
                </div>
                <div className='produto'>
